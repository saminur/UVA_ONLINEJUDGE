    ...
    while(1)
    {
        ...
        for(int i=0; i<edge; i++)
        {
            if(g[i].person=='Y')
            {
                ...
                if(g[i].direction=='U')
                {
                    if(g[i].cost<costArray[node[g[i].a]][node[g[i].b]])
                    {
                ...
                else
                {
                    ...
                    if(g[i].cost<costArray[node[g[i].b]][node[g[i].a]])
                    {
            ...
            else
            {
                if(g[i].direction=='U')
                {
                    if(g[i].cost<costArray2[node[g[i].a]][node[g[i].b]])
                    {
                ...
                else
                {
                    ...
                    if(g[i].cost<costArray2[node[g[i].b]][node[g[i].a]])
                    {
